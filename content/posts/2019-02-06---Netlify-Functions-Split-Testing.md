...
template: "post"
draft: false
slug: "netlify-functions-split-testing"
category: "Frontend"
tags:
  - "TypeScript"
  - "Nuxt.js"
  - "Netlify"
socialImage: "/media/netlify-functions-split-testing/ab.png"
---
...
![A/B Testing](/media/netlify-functions-split-testing/ab-testing.png)
...
![関数を呼び出した結果](/media/netlify-functions-split-testing/output.png)

## Split TestingでA/Bテストをやってみる

masterとfunctionsの両方のブランチを使ってA/Bテストをやってみる。使い方は直感的で迷う事はない。ここではmasterに10%、functionsに90%振り分けてみる。

![Split Testing](/media/netlify-functions-split-testing/split-testing.png)
